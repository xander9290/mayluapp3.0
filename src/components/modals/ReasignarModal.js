...
export default function ReasignarClienteModal(props) {
  const { setCuenta, cuenta, setCuentas, cuentas, setModalcaptura } = props;
...
function Formulario(props) {
  ...
  const aceptar = async () => {
    ...
    const newCuenta = await axios.put(apiURI + "/cuentas/"+cuenta.id, data);
    await commit("ha reasignado la orden en domicilio " + cuenta.orden, operadorSession);
